...
# Flatten all tags to create autocomplete options
...
if st.button("Save Note"):
    ...
    if image_file:
        img_folder = os.path.join(DATA_DIR, tag, "images")
    ...
    add_note(note)
    st.success(f"Note saved under {tag} with tags: {', '.join(selected_tags)}")

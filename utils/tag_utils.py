...
DO_NOT_SINGULARIZE = {
    # General uncountable / abstract nouns
    "news",
    "series",
    "analytics",
    "music",
    ...
    # Children / related
    "children",
    "kids",  # note: plural of child
    # Tips / Tricks
    "tips",
    "tricks",
    "tips_and_tricks",
    # Always-plural / irregular nouns
    "species",
    "headquarters",
    "clothes",
    "outdoors",
    # Taxonomy / category nouns
    "shoes",
    "podcasts",
    "services",
    "basics",
    ...
    "measles",
    "mumps",
    # "-ics" words (should not become analytic/statistic/etc.)
    "statistics",
    "mathematics",
    "physics",
    "economics",
